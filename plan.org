...
** THINGS TODO
   - test generic makefiles on c and c++ repos to see if they work (2 hours) (db has 47 as test set)
   - find variations of generic makefiles
