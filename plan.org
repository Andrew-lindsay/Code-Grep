...
* Programme:  
  ...
  - build data base (ensure repositories are unique)
  - use repository data to clone all github repos locally
	- need to work in parallel to pull repositories
	- query data base to get list
  - Interface to database to filter repos that get searched
